...
export const courses: Course[] = [
  {
    id: 'project1',
    title: 'Project 1: Shopping Cart Association Rules',
...
print(f"解释: 买了面包的用户中，有 {confidence*100:.1f}% 也买了鸡蛋")`,
  ...
  {
    id: 'project2',
    title: 'Project 2: RFM Analysis & Clustering',
...
print(outliers_iqr[["order_id", "amount"]])`,
  ...
  {
    id: 'project4',
    title: 'Project 4: Conversion Funnel Analysis',
...
print(f"平均单环节转化率: {df['conversion_rate'].mean():.2f}%")`,
  ...
  {
    id: 'project5',
    title: 'Project 5: Sales Trend & Seasonality',
...
print(f"平均环比增长率: {avg_mom:.2f}%")`,
  ...
  {
    id: 'project6',
    title: 'Project 6: Repurchase Interval & Lifecycle',
...
recommend_items("Milk 牛奶", top_n=2)`,
  ...
  {
    id: 'project9',
    title: 'Project 9: Campaign Effectiveness Analysis',
...
print(f"解释: 实验组比对照组平均高 \${diff:.2f}，95%可能在 \${ci_lower:.2f} ~ \${ci_upper:.2f} 之间")`,
  ...
  {
    id: 'project10',
    title: 'Project 10: End-to-End Data Cleaning & Profiling',
